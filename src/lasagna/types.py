...
class ChatMessage(TypedDict):
    ...
    text: Optional[str]                                       # <-- for the typical text-based messages
    tools: Optional[Union[List[ToolCall], List[ToolResult]]]  # <-- for tool-related messages
...
EventCallback = Callable[[Tuple[ChatMessageRole, str, Union[str, Dict]]], Awaitable[None]]
